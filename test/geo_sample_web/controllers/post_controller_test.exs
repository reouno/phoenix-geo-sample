defmodule GeoSampleWeb.PostControllerTest do
  use GeoSampleWeb.ConnCase

  alias GeoSample.Posts
  alias GeoSample.Posts.Post

  @create_attrs %{content: "some content", username: "some username"}
